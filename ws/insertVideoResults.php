...
// CAMBIO 1: Añadir video_url a los campos requeridos
$required_fields = [
    'video', 'video_url', 'analysis_mode', 'total_frames',
...
try {
    ...
    // CAMBIO 2: Añadir campo video_url y created_at
    ...
    if ($stmt->rowCount() > 0) {
        ...
        // CAMBIO 3: Devolver más información útil
        echo json_encode([
            'success' => 1,
            'message' => 'Resultados de video insertados correctamente',
            'id' => $lastInsertId,
            'video_url' => $_POST['video_url'],
            'total_frames' => intval($_POST['total_frames'])
        ]);
    } else {
